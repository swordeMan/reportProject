...
<div class="pageContent">
	<form id="createScrapForm" method="post" action="<c:url value='rest/scrap/insertByManager?callbackType=closeCurrent'/>" class="pageForm required-validate" onsubmit="return validateCallback(this, dialogAjaxDone);">
		<input type="hidden" name="scrap.saleOrderRow" value="${asv.saleOrderRow}">
		...
		<div class="pageFormContent" layoutH="56">
			...
			<p>
				<label>销售订单：</label>
				<input name="scrap.saleOrderId" readonly="readonly" type="text" value="${asv.saleOrderId}" size="30"/>
			</p>
			<p>
				<label>报废量：</label>
			...
			<p>
				<label>客户：</label>
				<input name="scrap.userSimpleName" readonly="readonly" type="text" size="30" value="${asv.userSimpleName}"/>
			</p>
			<p>
				<label>生产订单：</label>
				<input name="scrap.productOrderId" readonly="readonly" type="text" value="${asv.productOrderId}" size="30"/>
			</p>
			<!-- <p>
				<label>核准量：</label>
			...
			<p>
				<label>工序：</label>
				<input name="scrap.productionProcess" readonly="readonly" type="text" size="30" value="${asv.deiviceDescribe}"/>
			...
			<p>
				<label>物料编码：</label>
				<input name="scrap.materialId" readonly="readonly" type="text" value="${asv.materialId}" size="30"/>
			</p>
			<!-- <p>
				<label>工号：</label>
			...
			<p>
				<label>物料描述：</label>
				<input name="scrap.materialDescribe" readonly="readonly" type="text" value="${asv.materialDescribe}" size="30"/>
			</p>
			...
			<table class="list nowrap itemDetail" addButton="新增原因明细" width="100%">
				<thead>
					<tr>
						<th type="enum" name="scrapReasonRelation[#index#].sReasonId" enumUrl="rest/scrapReason/page?materialDescribe=${asv.materialDescribe}" size="12">报废原因</th>
