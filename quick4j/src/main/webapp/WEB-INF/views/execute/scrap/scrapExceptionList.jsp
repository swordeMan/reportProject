...
<form id="pagerForm" method="post" action="rest/scrap/scrapExceptionList">
...
<div class="pageHeader">
	<form rel="pagerForm" onsubmit="return navTabSearch(this);" action="rest/scrap/scrapExceptionList" method="post">
	<div class="searchBar">
	...
	<div class="panelBar">
		<ul class="toolBar">
			<%-- <shiro:hasPermission name="scrap:valide">
				...
				<li><a class="add" href="rest/scrap/reportAgain/{slt_objId}" target="ajaxTodo" warn="请选择报废单"><span>重新报工</span></a></li>
